...
func Get(ctx context.Context) v1alpha1.NodeInfoInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/kubernetes-local-volume/kubernetes-local-volume/pkg/client/informers/externalversions/storage/v1alpha1.NodeInfoInformer from context.")
	}
	return untyped.(v1alpha1.NodeInfoInformer)
}
