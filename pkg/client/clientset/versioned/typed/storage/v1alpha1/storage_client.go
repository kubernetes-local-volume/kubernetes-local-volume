...
import (
	...
	"github.com/kubernetes-local-volume/kubernetes-local-volume/pkg/client/clientset/versioned/scheme"
...
func (c *LocalV1alpha1Client) LocalVolumes(namespace string) LocalVolumeInterface {
