...
import (
	...
	storage "github.com/kubernetes-local-volume/kubernetes-local-volume/pkg/client/informers/externalversions/storage"
...
func (f *sharedInformerFactory) Local() storage.Interface {
