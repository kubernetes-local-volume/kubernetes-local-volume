...
type NodeInfoLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.NodeInfo, err error)
...
// List lists all NodeInfos in the indexer.
func (s *nodeInfoLister) List(selector labels.Selector) (ret []*v1alpha1.NodeInfo, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.NodeInfo))
	})
	return ret, err
}
...
type NodeInfoNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.NodeInfo, error)
...
// List lists all NodeInfos in the indexer for a given namespace.
func (s nodeInfoNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.NodeInfo, err error) {
...
// Get retrieves the NodeInfo from the indexer for a given namespace and name.
func (s nodeInfoNamespaceLister) Get(name string) (*v1alpha1.NodeInfo, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("nodeinfo"), name)
	}
	return obj.(*v1alpha1.NodeInfo), nil
}
