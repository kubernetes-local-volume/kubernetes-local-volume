...
import (
	...
	informergenargs "github.com/kubernetes-local-volume/kubernetes-local-volume/pkg/common/codegen/cmd/injection-gen/args"
)
...
func Packages(context *generator.Context, arguments *args.GeneratorArgs) generator.Packages {
	...
	klog.V(2).Infof("inputdirs: %v", arguments.InputDirs)
