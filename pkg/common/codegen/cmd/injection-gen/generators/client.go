...
func (g *clientGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"injectionRegisterClient":    c.Universe.Function(types.Name{Package: "github.com/kubernetes-local-volume/kubernetes-local-volume/pkg/common/injection", Name: "Default.RegisterClient"}),
